...
def generate_clart_layer(self, state, district, block, gee_account_id):
    ...
    drainage_density(state, district, block, gee_account_id)
    generate_lithology_layer(state, gee_account_id)
    clart_layer(state, district, block, gee_account_id)


def clart_layer(state, district, block, gee_account_id):
    description = (
        "clart_"
