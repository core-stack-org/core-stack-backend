...
class GEEAccount(models.Model):
    ...
    account_email = models.CharField(max_length=100, unique=True, blank=True, null=True)
    service_account_name = models.CharField(max_length=100, blank=True, null=True)
