...
item_id = openapi.Parameter('item_id', openapi.IN_FORM, description="Unique item ID.", type=openapi.TYPE_STRING, required=False)
title = openapi.Parameter('title', openapi.IN_FORM, description="Title of the item.", type=openapi.TYPE_STRING, required=False)
transcript = openapi.Parameter('transcript', openapi.IN_FORM, description="Transcript text.", type=openapi.TYPE_STRING, required=False)
category_id = openapi.Parameter('category_id', openapi.IN_FORM, description="Category identifier.", type=openapi.TYPE_INTEGER, required=True)
rating = openapi.Parameter('rating', openapi.IN_FORM, description="Rating value.", type=openapi.TYPE_INTEGER, required=False)
item_type = openapi.Parameter('item_type', openapi.IN_FORM, description="Type of the item.", type=openapi.TYPE_STRING, required=True)
coordinates = openapi.Parameter('coordinates', openapi.IN_FORM, description="JSON string of coordinates, e.g., '{\"lat\": 28.1, \"lon\": 77.5}'", type=openapi.TYPE_STRING, required=True)
community_id = openapi.Parameter('community_id', openapi.IN_FORM, description="Community identifier.", type=openapi.TYPE_INTEGER, required=True)
number = openapi.Parameter('number', openapi.IN_FORM, description="User's contact number.", type=openapi.TYPE_STRING, required=True)
source = openapi.Parameter('source', openapi.IN_FORM, description="Source of the data (e.g., 'BOT').", type=openapi.TYPE_STRING, required=True)
bot_id = openapi.Parameter('bot_id', openapi.IN_FORM, description="Bot ID (if source is 'BOT').", type=openapi.TYPE_INTEGER, required=False)
misc = openapi.Parameter('misc', openapi.IN_FORM, description="Miscellaneous JSON data string.", type=openapi.TYPE_STRING, required=False)
image_files = openapi.Parameter('image_files', openapi.IN_FORM, description="Image file(s) to upload.", type=openapi.TYPE_FILE, required=False)
audio_files = openapi.Parameter('audio_files', openapi.IN_FORM, description="Audio file(s) to upload.", type=openapi.TYPE_FILE, required=False)
...
@swagger_auto_schema(
    ...
    **Response dataset details:**
    ...
    ```
    """,
    manual_parameters=[item_id, title, transcript, category_id, rating, item_type, coordinates, community_id, number, source, bot_id, misc, state, image_files, audio_files],
    responses={
        201: openapi.Response(description="Created - Item created successfully",examples={"application/json": {"success": True,"message": "Item created","item_id": 12}}),
        200: openapi.Response(description="Success - Item updated successfully",examples={"application/json": {"success": True,"message": "Item updated","item_id": 12}}),
        400: openapi.Response(description="Bad Request - Missing or invalid parameters",examples={"application/json": {"success": False,"message": "Missing required fields for item creation."}}),
...
@swagger_auto_schema(
    ...
    **Response dataset details:**
    ...
    responses={
        200: openapi.Response(description="Success - Media attached successfully",examples={"application/json": {"success": True,"message": "Media attached successfully"}}),
        400: openapi.Response(description="Bad Request - Missing number OR bot_id is required when source is BOT",examples={"application/json": {"success": False,"message": "Missing number OR bot_id is required when source is BOT."}}),
        404: openapi.Response(description="Not Found - Item not found",examples={"application/json": {"success": False,"message": "Item not found"}}),
        500: openapi.Response(description="Internal Server Error",examples={"application/json": {"success": False,"message": "Internal server error"}})
    },
    tags=['Community Engagement']
...
@swagger_auto_schema(
    ...
    **Response dataset details:**
    ...
    """,
    manual_parameters=[
        openapi.Parameter('community_id', openapi.IN_QUERY, description="ID of the community", type=openapi.TYPE_INTEGER, required=True)
    ],
    responses={
        200: openapi.Response(description="Success - Returns community details",examples={"application/json": {"success": True,"data": {"id": 1,"name": "Community Name","description": "Community description","organization": "Organization Name","member_count": 150,"location": "Location details","created_at": "2023-01-01T00:00:00Z"}}}),
...
def get_community_details(request):
    try:
        ...
        return Response({"success": False, "message": "An internal server error occurred."}, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
...
@swagger_auto_schema(
    ...
    **Response dataset details:**
    ...
    manual_parameters=[
        openapi.Parameter('latitude', openapi.IN_QUERY, description="Latitude value", type=openapi.TYPE_NUMBER, required=True),
        openapi.Parameter('longitude', openapi.IN_QUERY, description="Longitude value", type=openapi.TYPE_NUMBER, required=True),
    ],
    responses={
        200: openapi.Response(description="Success - Returns communities data",examples={"application/json": {"success": True,"data": [{"id": 1,"name": "Community Name","description": "Community description","organization": "Organization Name","member_count": 150,"location": "Location details"}]}}),
...
def get_communities_by_lat_lon(request):
    try:
        ...
        if lat is None or lon is None:
            return Response({"error": "Both 'latitude' and 'longitude' parameters are required."}, status=status.HTTP_400_BAD_REQUEST)
...
@swagger_auto_schema(
    ...
    **Response dataset details:**
    ...
    """,
    manual_parameters=[
        openapi.Parameter('number', openapi.IN_QUERY, description="User's contact number", type=openapi.TYPE_STRING, required=True),
    ],
    responses={
        200: openapi.Response(description="Success - Returns user's communities",examples={"application/json": {"success": True,"data": [{"id": 1,"name": "Community Name","description": "Community description","organization": "Organization Name","member_count": 150,"location": "Location details"}]}}),
        400: openapi.Response(description="Bad Request - Contact number is required.",examples={"application/json": {"success": False,"message": "Contact number is required."}}),
...
def get_community_by_user(request):
    try:
        ...
        if not number:
            return Response({"success": False, "message": "Contact number is required."}, status=status.HTTP_400_BAD_REQUEST)
...
@swagger_auto_schema(
    ...
    **Response dataset details:**
    ...
    """,
    manual_parameters=[
        openapi.Parameter('project_id', openapi.IN_FORM, description="ID of the Community Engagement project.", type=openapi.TYPE_INTEGER, required=True),
        openapi.Parameter('file', openapi.IN_FORM, description="CSV file with user phone numbers as columns.", type=openapi.TYPE_FILE, required=True),
    ],
    responses={
        201: openapi.Response(description="Created - Users mapped to community successfully",examples={"application/json": {"success": True,"message": "Users mapped to community successfully."}}),
        400: openapi.Response(description="Bad Request - Project ID is required. OR Community Engagement project not found or not enabled OR No files were uploaded.",examples={"application/json": {"detail": "Project ID is required. OR Community Engagement project not found or not enabled OR No files were uploaded."}}),
...
@swagger_auto_schema(
    ...
    **Response dataset details:**
    ...
    """,
    manual_parameters=[
        openapi.Parameter('community_id', openapi.IN_FORM, description="Community identifier", type=openapi.TYPE_INTEGER, required=True),
        openapi.Parameter('number', openapi.IN_FORM, description="User's contact number", type=openapi.TYPE_STRING, required=True),
    ],
    responses={
        201: openapi.Response(description="Success - User added to community successfully",examples={"application/json": {"success": True,"message": "User added to community successfully."}}),
        200: openapi.Response(description="Success - User was already in the community",examples={"application/json": {"success": True,"message": "User was already in the community."}}),
        400: openapi.Response(description="Bad Request",examples={"application/json": {"detail": "Community ID is required."}}),
...
def add_user_to_community(request):
    try:
        ...
        if mapping_created:
            return Response({"success": True, "message": "User added to community successfully."}, status=status.HTTP_201_CREATED)
        else:
            return Response({"success": True, "message": "User was already in the community."}, status=status.HTTP_200_OK)
...
@swagger_auto_schema(
    ...
    **Response dataset details:**
    ...
    responses={
        200: openapi.Response(description="Success",examples={"application/json": {"success": True,"data": {"is_in_community": True,"data_type": "community", "data": [{"community_id": 4,"name": "NREGASathi","description": "NREGA Companions","organization": "CFPT"}],"misc": {"last_accessed_community_id": 4}}}}),
...
def is_user_in_community(request):
    try:
        number = request.data.get("number")
        if not number:
            return Response({"success": False,"message": "Either 'number' field is missing or it is empty."},status=status.HTTP_400_BAD_REQUEST)
...
@swagger_auto_schema(
    ...
    **Response dataset details:**
    ...
    """,
    manual_parameters=[
        openapi.Parameter('state_id', openapi.IN_QUERY, required=True, type=openapi.TYPE_INTEGER, description="ID of the state to filter districts")
    ],
    responses={
        200: openapi.Response(description="Success",examples={"application/json": {"success": True,"data": [{"id": 63, "name": "Deoghar"},{"id": 75, "name": "Dumka"},{"id": 66, "name": "Pakur"}]}}),
        400: openapi.Response(description="Bad Request - State ID is required.",examples={"application/json": {"success": False,"message": "State ID is required."}}),
...
@swagger_auto_schema(
    ...
    **Response dataset details:**
    ...
    responses={
        200: openapi.Response(description="Success - Last accessed community updated successfully.",examples={"application/json": {"success": True,"message": "Last accessed community updated successfully."}}),
...
def update_last_accessed_community(request):
    try:
        ...
        return Response({"success": True, "message": "Last accessed community updated successfully."}, status=status.HTTP_200_OK)
    except Exception as e:
        print("Exception in update_last_accessed_community API :: ", e)
        return Response({"success": False, "error": "An internal server error occurred."}, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
...
@swagger_auto_schema(
    ...
    **Response dataset details:**
    ...
    """,
    manual_parameters=[
        openapi.Parameter('community_id', openapi.IN_QUERY, required=True, type=openapi.TYPE_INTEGER, description="ID of the community"),
        openapi.Parameter('item_type', openapi.IN_QUERY, type=openapi.TYPE_STRING, description="Type of items to filter"),
        openapi.Parameter('item_state', openapi.IN_QUERY, type=openapi.TYPE_STRING, description="State of items to filter (requires item_type)"),
        openapi.Parameter('limit', openapi.IN_QUERY, type=openapi.TYPE_INTEGER, default=10, description="Number of items per page"),
        openapi.Parameter('offset', openapi.IN_QUERY, type=openapi.TYPE_INTEGER, default=0, description="Number of items to skip"),
    ],
    responses={
        200: openapi.Response(description="Success - Returns items data",examples={"application/json": {"success": True,"data": [{"id": 7,"number": "917702828811","title": "Asset Demand - 10 Sep 2025, 11:50 AM","item_type": "ASSET_DEMAND","state": "UNMODERATED","created_at": "2025-09-10 06:20:52","latitude": 24.9175964,"longitude": 86.2940056,"images": ["https://communityengagementstack.s3.ap-south-1.amazonaws.com/images/7dd5c2e0-7e5e-400d-9b8d-19e243642443.jpeg"],"audios": ["https://communityengagementstack.s3.ap-south-1.amazonaws.com/audios/bacfd6c6-ec9b-4706-8265-7a19ecece286.wav"]}],"total": 1,"limit": 5,"offset": 0,"has_more": True}}),
...
@swagger_auto_schema(
    ...
    **Response dataset details:**
    ...
    """,
    manual_parameters=[
        openapi.Parameter('number', openapi.IN_QUERY, description="User's contact number", required=True, type=openapi.TYPE_STRING),
        openapi.Parameter('bot_id', openapi.IN_QUERY, type=openapi.TYPE_INTEGER, description="Filter by bot ID"),
        openapi.Parameter('community_id', openapi.IN_QUERY, type=openapi.TYPE_INTEGER, description="Filter by community ID"),
        openapi.Parameter('asset_demand_only', openapi.IN_QUERY, type=openapi.TYPE_BOOLEAN, default=False, description="Filter only asset demand items"),
    ],
    responses={
        200: openapi.Response(description="Success - Returns user's items status data",examples={"application/json": {"success": True,"data": [{"id": 8,"title": "Grievance - 11 Sep 2025, 1:44 PM","transcription": "","status": "UNMODERATED"}]}}),
        400: openapi.Response(description="Bad Request - contact_number is required.",examples={"application/json": {"success": False,"message": "'contact_number' is required."}}),
        404: openapi.Response(description="Not Found - User not found",examples={"application/json": {"success": False,"message": "User not found."}}),
        500: openapi.Response(description="Internal Server Error",examples={"application/json": {"success": False,"message": "Internal server error."}})
    },
    tags=['Community Engagement']
