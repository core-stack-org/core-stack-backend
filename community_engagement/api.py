...
from .models import (
    Community, Item, Community_user_mapping, Media, Media_type, Location,
    Item_type, Item_state, ITEM_TYPE_STATE_MAP, Item_category
)
...
item_id = openapi.Parameter('item_id', openapi.IN_FORM, description="Unique item ID.", type=openapi.TYPE_STRING,
                            required=False)
title = openapi.Parameter('title', openapi.IN_FORM, description="Title of the item.", type=openapi.TYPE_STRING,
                          required=False)
transcript = openapi.Parameter('transcript', openapi.IN_FORM, description="Transcript text.", type=openapi.TYPE_STRING,
                               required=False)
category_id = openapi.Parameter('category_id', openapi.IN_FORM, description="Category identifier.",
                                type=openapi.TYPE_INTEGER, required=True)
rating = openapi.Parameter('rating', openapi.IN_FORM, description="Rating value.", type=openapi.TYPE_INTEGER,
                           required=False)
item_type = openapi.Parameter('item_type', openapi.IN_FORM, description="Type of the item.", type=openapi.TYPE_STRING,
                              required=True)
coordinates = openapi.Parameter('coordinates', openapi.IN_FORM,
                                description="JSON string of coordinates, e.g., '{\"lat\": 28.1, \"lon\": 77.5}'",
                                type=openapi.TYPE_STRING, required=True)
community_id = openapi.Parameter('community_id', openapi.IN_FORM, description="Community identifier.",
                                 type=openapi.TYPE_INTEGER, required=True)
number = openapi.Parameter('number', openapi.IN_FORM, description="User's contact number.", type=openapi.TYPE_STRING,
                           required=True)
source = openapi.Parameter('source', openapi.IN_FORM, description="Source of the data (e.g., 'BOT').",
                           type=openapi.TYPE_STRING, required=True)
bot_id = openapi.Parameter('bot_id', openapi.IN_FORM, description="Bot ID (if source is 'BOT').",
                           type=openapi.TYPE_INTEGER, required=False)
misc = openapi.Parameter('misc', openapi.IN_FORM, description="Miscellaneous JSON data string.",
                         type=openapi.TYPE_STRING, required=False)
image_files = openapi.Parameter('image_files', openapi.IN_FORM, description="Image file(s) to upload.",
                                type=openapi.TYPE_FILE, required=False)
audio_files = openapi.Parameter('audio_files', openapi.IN_FORM, description="Audio file(s) to upload.",
                                type=openapi.TYPE_FILE, required=False)
state = openapi.Parameter('state', openapi.IN_FORM, type=openapi.TYPE_STRING, description="State of the item")

response_param = openapi.Parameter('X-API-Key', openapi.IN_HEADER, description="API Key in format: <your-api-key>",
                                   type=openapi.TYPE_STRING, required=True)
...
@swagger_auto_schema(
    ...
    **Response dataset details:**
    ...
    ```
    """,
    manual_parameters=[item_id, title, transcript, category_id, rating, item_type, coordinates, community_id, number,
                       source, bot_id, misc, state, image_files, audio_files],
    responses={
        201: openapi.Response(description="Created - Item created successfully", examples={
            "application/json": {"success": True, "message": "Item created", "item_id": 12}}),
        200: openapi.Response(description="Success - Item updated successfully", examples={
            "application/json": {"success": True, "message": "Item updated", "item_id": 12}}),
        400: openapi.Response(description="Bad Request - Missing or invalid parameters", examples={
            "application/json": {"success": False, "message": "Missing required fields for item creation."}}),
        404: openapi.Response(description="Not Found - Item not found",
                              examples={"application/json": {"success": False, "message": "Item not found"}}),
        500: openapi.Response(description="Internal Server Error",
                              examples={"application/json": {"success": False, "message": "Internal Server Error"}})
    },
...
@swagger_auto_schema(
    ...
    **Response dataset details:**
    ...
    responses={
        200: openapi.Response(description="Success - Media attached successfully", examples={
            "application/json": {"success": True, "message": "Media attached successfully"}}),
        400: openapi.Response(description="Bad Request - Missing number OR bot_id is required when source is BOT",
...
@swagger_auto_schema(
    ...
    **Response dataset details:**
    ...
    """,
    manual_parameters=[
        openapi.Parameter('community_id', openapi.IN_QUERY, description="ID of the community",
                          type=openapi.TYPE_INTEGER, required=True)
    ],
    responses={
        200: openapi.Response(description="Success - Returns community details", examples={
            "application/json": {"success": True,
                                 "data": {"id": 1, "name": "Community Name", "description": "Community description",
                                          "organization": "Organization Name", "member_count": 150,
                                          "location": "Location details", "created_at": "2023-01-01T00:00:00Z"}}}),
        400: openapi.Response(description="Bad Request - The community_id parameter is required.", examples={
            "application/json": {"success": False, "message": "The 'community_id' parameter is required."}}),
        500: openapi.Response(description="Internal Server Error", examples={
            "application/json": {"success": False, "message": "An internal server error occurred."}})
    },
    tags=['Community Engagement APIs']
)
@api_view(["GET"])
...
def get_community_details(request):
    try:
        ...
        return Response({"success": False, "message": "An internal server error occurred."},
                        status=status.HTTP_500_INTERNAL_SERVER_ERROR)
...
@swagger_auto_schema(
    ...
    **Response dataset details:**
    ...
    responses={
        200: openapi.Response(description="Success - Returns communities data", examples={
            "application/json": {"success": True, "data": [
                {"id": 1, "name": "Community Name", "description": "Community description",
                 "organization": "Organization Name", "member_count": 150, "location": "Location details"}]}}),
        ...
        404: openapi.Response(description="Not Found - State not found OR District not found OR Tehsil not found",
                              examples={"application/json": {"success": False, "message": "State not found"}}),
        500: openapi.Response(description="Internal Server Error", examples={
            "application/json": {"success": False, "message": "An internal server error occurred."}})
    },
    tags=['Community Engagement APIs']
...
@swagger_auto_schema(
    ...
    **Response dataset details:**
    ...
    manual_parameters=[
        openapi.Parameter('latitude', openapi.IN_QUERY, description="Latitude value", type=openapi.TYPE_NUMBER,
                          required=True),
        openapi.Parameter('longitude', openapi.IN_QUERY, description="Longitude value", type=openapi.TYPE_NUMBER,
                          required=True),
    ],
    responses={
        200: openapi.Response(description="Success - Returns communities data", examples={
            "application/json": {"success": True, "data": [
                {"id": 1, "name": "Community Name", "description": "Community description",
                 "organization": "Organization Name", "member_count": 150, "location": "Location details"}]}}),
        400: openapi.Response(description="Bad Request - Both 'latitude' and 'longitude' parameters are required.",
...
def get_communities_by_lat_lon(request):
    try:
        ...
        if lat is None or lon is None:
            return Response({"error": "Both 'latitude' and 'longitude' parameters are required."},
                            status=status.HTTP_400_BAD_REQUEST)
        if not (-90 <= lat <= 90 and -180 <= lon <= 180):
            return Response({"error": "Latitude or longitude out of bounds."}, status=status.HTTP_400_BAD_REQUEST)
...
@swagger_auto_schema(
    ...
    **Response dataset details:**
    ...
    """,
    manual_parameters=[
        openapi.Parameter('number', openapi.IN_QUERY, description="User's contact number", type=openapi.TYPE_STRING,
                          required=True),
    ],
    responses={
        200: openapi.Response(description="Success - Returns user's communities", examples={
            "application/json": {"success": True, "data": [
                {"id": 1, "name": "Community Name", "description": "Community description",
                 "organization": "Organization Name", "member_count": 150, "location": "Location details"}]}}),
        400: openapi.Response(description="Bad Request - Contact number is required.", examples={
            "application/json": {"success": False, "message": "Contact number is required."}}),
        404: openapi.Response(description="Not Found - User not found",
                              examples={"application/json": {"success": False, "message": "User not found."}}),
        500: openapi.Response(description="Internal Server Error", examples={
            "application/json": {"success": False, "message": "An internal server error occurred."}})
    },
    tags=['Community Engagement APIs']
...
def get_community_by_user(request):
    try:
        ...
        if not number:
            return Response({"success": False, "message": "Contact number is required."},
                            status=status.HTTP_400_BAD_REQUEST)
...
@swagger_auto_schema(
    ...
    **Response dataset details:**
    ...
    """,
    manual_parameters=[
        openapi.Parameter('project_id', openapi.IN_FORM, description="ID of the Community Engagement project.",
                          type=openapi.TYPE_INTEGER, required=True),
        openapi.Parameter('file', openapi.IN_FORM, description="CSV file with user phone numbers as columns.",
                          type=openapi.TYPE_FILE, required=True),
    ],
    responses={
        201: openapi.Response(description="Created - Users mapped to community successfully", examples={
            "application/json": {"success": True, "message": "Users mapped to community successfully."}}),
        400: openapi.Response(
        ...
        404: openapi.Response(description="Not Found - Community not found",
...
@swagger_auto_schema(
    ...
    **Response dataset details:**
    ...
    """,
    manual_parameters=[
        openapi.Parameter('community_id', openapi.IN_FORM, description="Community identifier",
                          type=openapi.TYPE_INTEGER, required=True),
        openapi.Parameter('number', openapi.IN_FORM, description="User's contact number", type=openapi.TYPE_STRING,
                          required=True),
    ],
    responses={
        201: openapi.Response(description="Success - User added to community successfully", examples={
            "application/json": {"success": True, "message": "User added to community successfully."}}),
        200: openapi.Response(description="Success - User was already in the community", examples={
            "application/json": {"success": True, "message": "User was already in the community."}}),
        ...
        500: openapi.Response(description="Internal Server Error",
                              examples={"application/json": {"detail": "An internal server error occurred."}})
    },
    tags=['Community Engagement APIs']
)
@api_view(["POST"])
...
def add_user_to_community(request):
    try:
        ...
        if not community_id:
            return Response({"detail": "Community ID is required."}, status=status.HTTP_400_BAD_REQUEST)

        if not number:
            return Response({"detail": "User contact number is required."}, status=status.HTTP_400_BAD_REQUEST)

        # Check if community exists
        if not Community.objects.filter(id=community_id).exists():
            return Response({"detail": "Community does not exist."}, status=status.HTTP_404_NOT_FOUND)

        # Check if user already exists in this community
        user, user_created = User.objects.get_or_create(contact_number=number, defaults={'username': number})
        mapping, mapping_created = Community_user_mapping.objects.get_or_create(community_id=community_id, user=user)

        if mapping_created:
            return Response({"success": True, "message": "User added to community successfully."},
                            status=status.HTTP_201_CREATED)
        else:
            return Response({"success": True, "message": "User was already in the community."},
                            status=status.HTTP_200_OK)
...
@swagger_auto_schema(
    ...
    **Response dataset details:**
    ...
    request_body=openapi.Schema(
        ...
        required=['number'],
        properties={
            'number': openapi.Schema(type=openapi.TYPE_STRING, description="User's contact number")
        }
    ),
    responses={
        200: openapi.Response(description="Success", examples={"application/json": {"success": True,
                                                                                    "data": {"is_in_community": True,
                                                                                             ...
                                                                                             "misc": {
                                                                                                 "last_accessed_community_id": 4}}}}),
        400: openapi.Response(description="Bad Request - Either 'number' field is missing or it is empty.", examples={
            "application/json": {"success": False, "message": "Either 'number' field is missing or it is empty."}}),
        404: openapi.Response(description="Not Found - User doesnot Exist.",
                              examples={"application/json": {"success": False, "message": "User doesnot Exist."}}),
        500: openapi.Response(description="Internal Server Error", examples={
            "application/json": {"success": False, "message": "An internal server error occurred."}})},
    tags=['Community Engagement APIs']
)
...
def is_user_in_community(request):
    try:
        number = request.data.get("number")
        if not number:
            return Response({"success": False, "message": "Either 'number' field is missing or it is empty."},
                            status=status.HTTP_400_BAD_REQUEST)
        ...
        if user_objs.exists():
            ...
            return Response({"success": False, "message": "User doesnot Exist"}, status=status.HTTP_404_NOT_FOUND)
...
@swagger_auto_schema(
    ...
    **Response dataset details:**
    ...
    """,
    manual_parameters=[
        openapi.Parameter('state_id', openapi.IN_QUERY, required=True, type=openapi.TYPE_INTEGER,
                          description="ID of the state to filter districts")
    ],
    responses={
        200: openapi.Response(description="Success", examples={"application/json": {"success": True, "data": [
            {"id": 63, "name": "Deoghar"}, {"id": 75, "name": "Dumka"}, {"id": 66, "name": "Pakur"}]}}),
        400: openapi.Response(description="Bad Request - State ID is required.",
                              examples={"application/json": {"success": False, "message": "State ID is required."}}),
        404: openapi.Response(description="Not Found - State does not exist.",
                              examples={"application/json": {"success": False, "message": "State does not exist."}}),
        500: openapi.Response(description="Internal Server Error", examples={
            "application/json": {"success": False, "message": "An internal server error occurred."}})
    },
    tags=['Community Engagement APIs']
...
@swagger_auto_schema(
    ...
    **Response dataset details:**
    ...
    """,
    manual_parameters=[
        openapi.Parameter('district_id', openapi.IN_QUERY, required=True, type=openapi.TYPE_INTEGER,
                          description="ID of the district to filter tehsils")
    ],
    responses={
        200: openapi.Response(description="Success - It will return json with data.", examples={
            "application/json": {"success": True,
                                 "data": [{"id": 1, "name": "Tehsil A"}, {"id": 2, "name": "Tehsil B"}]}}),
        400: openapi.Response(description="Bad Request - District ID is required.",
                              examples={"application/json": {"success": False, "message": "District ID is required."}}),
        404: openapi.Response(description="Not Found - District does not exist.",
                              examples={"application/json": {"success": False, "message": "District does not exist."}}),
        500: openapi.Response(description="Internal Server Error", examples={
            "application/json": {"success": False, "message": "An internal server error occurred."}})
    },
    tags=['Community Engagement APIs']
...
@swagger_auto_schema(
    ...
    **Response dataset details:**
    ...
    responses={
        200: openapi.Response(description="Success - Last accessed community updated successfully.", examples={
            "application/json": {"success": True, "message": "Last accessed community updated successfully."}}),
        400: openapi.Response(description="Bad Request - user_id and community_id are required.", examples={
            "application/json": {"success": False, "error": "user_id and community_id are required."}}),
        500: openapi.Response(description="Internal Server Error", examples={
            "application/json": {"success": False, "error": "An internal server error occurred."}})
    },
    tags=['Community Engagement APIs']
)
@api_view(["POST"])
...
def update_last_accessed_community(request):
    try:
        ...
        Community_user_mapping.objects.filter(user_id=user_id).exclude(pk=mapping.pk).update(
            is_last_accessed_community=False)
        return Response({"success": True, "message": "Last accessed community updated successfully."},
                        status=status.HTTP_200_OK)
    except Exception as e:
        print("Exception in update_last_accessed_community API :: ", e)
        return Response({"success": False, "error": "An internal server error occurred."},
                        status=status.HTTP_500_INTERNAL_SERVER_ERROR)
...
@swagger_auto_schema(
    ...
    **Response dataset details:**
    ...
    """,
    manual_parameters=[
        openapi.Parameter('community_id', openapi.IN_QUERY, required=True, type=openapi.TYPE_INTEGER,
                          description="ID of the community"),
        openapi.Parameter('item_type', openapi.IN_QUERY, type=openapi.TYPE_STRING,
                          description="Type of items to filter"),
        openapi.Parameter('item_state', openapi.IN_QUERY, type=openapi.TYPE_STRING,
    ...
    responses={
        200: openapi.Response(description="Success - Returns items data", examples={
            "application/json": {"success": True, "data": [
                {"id": 7, "number": "917702828811", "title": "Asset Demand - 10 Sep 2025, 11:50 AM",
                 "item_type": "ASSET_DEMAND", "state": "UNMODERATED", "created_at": "2025-09-10 06:20:52",
                 "latitude": 24.9175964, "longitude": 86.2940056, "images": [
                    "https://communityengagementstack.s3.ap-south-1.amazonaws.com/images/7dd5c2e0-7e5e-400d-9b8d-19e243642443.jpeg"],
                 "audios": [
                     "https://communityengagementstack.s3.ap-south-1.amazonaws.com/audios/bacfd6c6-ec9b-4706-8265-7a19ecece286.wav"]}],
                                 "total": 1, "limit": 5, "offset": 0, "has_more": True}}),
        400: openapi.Response(description="Bad Request - Missing 'community_id' in query parameters.", examples={
            "application/json": {"success": False, "message": "Missing 'community_id' in query parameters."}}),
        500: openapi.Response(description="Internal Server Error",
                              examples={"application/json": {"success": False, "message": "Internal server error."}})
    },
    tags=['Community Engagement APIs']
...
@swagger_auto_schema(
    ...
    **Response dataset details:**
    ...
    """,
    manual_parameters=[
        openapi.Parameter('number', openapi.IN_QUERY, description="User's contact number", required=True,
                          type=openapi.TYPE_STRING),
        openapi.Parameter('bot_id', openapi.IN_QUERY, type=openapi.TYPE_INTEGER, description="Filter by bot ID"),
        openapi.Parameter('community_id', openapi.IN_QUERY, type=openapi.TYPE_INTEGER,
                          description="Filter by community ID"),
        openapi.Parameter('asset_demand_only', openapi.IN_QUERY, type=openapi.TYPE_BOOLEAN, default=False,
                          description="Filter only asset demand items"),
    ],
    responses={
        200: openapi.Response(description="Success - Returns user's items status data", examples={
            "application/json": {"success": True, "data": [
                {"id": 8, "title": "Grievance - 11 Sep 2025, 1:44 PM", "transcription": "",
                 "status": "UNMODERATED"}]}}),
        400: openapi.Response(description="Bad Request - contact_number is required.", examples={
            "application/json": {"success": False, "message": "'contact_number' is required."}}),
        404: openapi.Response(description="Not Found - User not found",
                              examples={"application/json": {"success": False, "message": "User not found."}}),
        500: openapi.Response(description="Internal Server Error",
                              examples={"application/json": {"success": False, "message": "Internal server error."}})
