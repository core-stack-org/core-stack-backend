...
urlpatterns = [
    ...
    path("generate_block_layer/", api.generate_admin_boundary, name="generate_block_layer"),
    ...
    path("generate_drought_layer/", api.generate_drought_layer, name="generate_drought_layer"),
    path("generate_terrain_descriptor/", api.generate_terrain_descriptor, name="generate_terrain_descriptor"),
    path("generate_terrain_raster/", api.generate_terrain_raster, name="generate_terrain_raster"),
    path("terrain_lulc_slope_cluster/", api.terrain_lulc_slope_cluster, name="terrain_lulc_slope_cluster"),
    path("terrain_lulc_plain_cluster/", api.terrain_lulc_plain_cluster, name="terrain_lulc_plain_cluster"),
    ...
    path("change_detection_vector/", api.change_detection_vector, name="change_detection_vector"),
    ...
    path("mws_drought_causality/", api.mws_drought_causality, name="mws_drought_causality"),
    path("gee_task_status/", api.gee_task_status, name="gee_task_status"),
    path("generate_nrega_layer/", api.generate_nrega_layer, name="generate_nrega_layer"),
    path("generate_drainage_layer/", api.generate_drainage_layer, name="generate_drainage_layer"),
    path("generate_drainage_density/", api.generate_drainage_density, name="generate_drainage_density"),
