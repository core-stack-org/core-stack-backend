...
GEE_TEST_SERVICE_ACCOUNT_KEY_PATH = env("GEE_TEST_SERVICE_ACCOUNT_KEY_PATH")
PAN_INDIA_LULC_PATH='projects/corestack-datasets/assets/datasets/LULC_v3_river_basin/'
PAN_INDIA_MWS_PATH='projects/corestack-datasets/assets/datasets/India_mws_uid_area_gt_500'
