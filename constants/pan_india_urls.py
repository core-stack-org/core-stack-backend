CATCHMETN_AREA = "projects/ext-datasets/assets/datasets/catchment_area_singleflow"
NATURAL_DEPRESSION = "projects/ext-datasets/assets/datasets/Natural_depression_raster"
