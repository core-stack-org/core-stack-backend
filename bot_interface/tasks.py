    ...
    try:
        ...
        if success and response_json.get("success"):
            ...
            if is_in_community:
                ...
                if is_new_user:
                    ...
                    try:
                        ...
                        if len(user_session.current_session) == 0:
                            ...
                            if event_packet.get("type") in ["button", "interactive", "location", "audio",
                                                            "voice"] and event_packet.get("event"):
                ...
                logger.info("Current event packet after checking start session and event type flags: %s",
                            event_packet)  # Debugging current session content
                print("=" * 50)
