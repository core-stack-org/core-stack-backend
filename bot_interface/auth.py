...
import json
from nrm_app.settings import AUTH_TOKEN_360, ES_AUTH, CALL_PATCH_API_KEY


BSP_Headers = {
    "HEADERS_360": {
        "Authorization": f"Bearer {AUTH_TOKEN_360}",
        "Content-Type": "application/json",
    }
}

BSP_URLS = {"URL_360": "https://graph.facebook.com/v24.0/926143897238253/"}
