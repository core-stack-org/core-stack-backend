...
class SmjController(StateMapData):
    ...
    def __init__(self, states, smj_id, app_type, bot_id, user_id, language, current_state, current_session):
        super(SmjController, self).__init__(states, smj_id, app_type, bot_id, user_id, language, current_state,
                                            current_session)
    ...
    def runSmj(self, event_data):
        ...
        if event_data:
            if event_data.get("event") == "start":
                ...
                default_state = self.jumpTodefaultSmj(self.states, event_data.get("smj_id"),
                                                      event_data.get("init_state"))
            ...
            if event_data.get("event") != "start" or (
                    event_data.get("event") == "start" and event_data.get("type") == "button"):
                # print("POSTTT")
