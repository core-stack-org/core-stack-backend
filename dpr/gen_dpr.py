...
def create_table_village_brief(
    ...
    headers_data = [
        ...
        ("Tehsil", to_utf8(plan.block.block_name)),
        ("District", to_utf8(plan.district.district_name)),
        ("State", to_utf8(plan.state.state_name)),
...
def create_table_mgnrega_info(doc, plan, settlement_data):
    ...
    for settlement_nrega in settlement_data:
        ...
        row_cells[3].text = to_utf8(format_text_demands(settlement_nrega.nrega_past_work))
...
def create_table_crop_info(doc, plan):
    ...
    for crop in crops_in_plan:
        ...
        row_cells[2].text = to_utf8(format_text(crop.cropping_patterns_kharif))
        ...
        if kharif_area != "NA" and kharif_area is not None:
            ...
            row_cells[3].text = "NA"
        row_cells[4].text = to_utf8(format_text(crop.cropping_patterns_rabi))
        rabi_area = (
        ...
        if rabi_area != "NA" and rabi_area is not None:
            ...
            row_cells[5].text = "NA"
        row_cells[6].text = to_utf8(format_text(crop.cropping_patterns_zaid))
        zaid_area = (
        ...
        if zaid_area != "NA" and zaid_area is not None:
            ...
            row_cells[7].text = "NA"
        row_cells[8].text = to_utf8(crop.agri_productivity)
...
def create_table_livestock(doc, plan):
    ...
    for livelihood in livestock_in_plan:
        ...
        row_cells[0].text = to_utf8(livelihood.settlement_name)
        ...
        for i, livestock_type in enumerate(livestock_types, start=1):
            ...
            row_cells[i].text = to_utf8(format_livestock_value(value))
...
def maintenance_gw_table(doc, plan):
    ...
    for maintenance in GW_maintenance.objects.filter(plan_id=plan.id):
        ...
        row_cells[3].text = to_utf8(maintenance.data_gw_maintenance.get("select_gender") or "NA")
        row_cells[4].text = to_utf8(maintenance.data_gw_maintenance.get("ben_father") or "NA")
...
def maintenance_agri_table(doc, plan):
    ...
    for maintenance in Agri_maintenance.objects.filter(plan_id=plan.id):
        ...
        row_cells[3].text = to_utf8(maintenance.data_agri_maintenance.get("gender") or "NA")
        row_cells[4].text = to_utf8(maintenance.data_agri_maintenance.get("ben_father") or "NA")
        row_cells[5].text = to_utf8(
...
def maintenance_waterstructures_table(doc, plan):
    ...
    for maintenance in SWB_maintenance.objects.filter(plan_id=plan.id):
        ...
        row_cells[4].text = to_utf8(maintenance.data_swb_maintenance.get("ben_father") or "NA")
        row_cells[5].text = to_utf8(
...
def maintenance_rs_waterstructures_table(doc, plan):
    ...
    for maintenance in SWB_RS_maintenance.objects.filter(plan_id=plan.id):
        ...
        row_cells[3].text = to_utf8(maintenance.data_swb_rs_maintenance.get("gender") or "NA")
...
def create_nrm_works_table(doc, plan, mws):
    ...
    for i, structure in enumerate(recharge_works, start=1):
        ...
        row_cells[2].text = to_utf8(structure.data_groundwater.get("demand_type") or "NA")
        row_cells[3].text = to_utf8(structure.work_type)
        row_cells[4].text = to_utf8(structure.beneficiary_settlement)
        row_cells[5].text = to_utf8(structure.data_groundwater.get("Beneficiary_Name") or "NA")
        row_cells[6].text = to_utf8(structure.data_groundwater.get("select_gender") or "NA")
        row_cells[7].text = to_utf8(structure.data_groundwater.get("ben_father") or "NA")
    ...
    for i, irr_work in enumerate(irrigation_works, start=offset):
        ...
        if (
            ...
            row_cells[3].text = to_utf8(irr_work.work_type)
        row_cells[4].text = to_utf8(irr_work.beneficiary_settlement)
        row_cells[5].text = to_utf8(irr_work.data_agri.get("Beneficiary_Name") or "NA")
        row_cells[6].text = to_utf8(irr_work.data_agri.get("gender") or "NA")
        row_cells[7].text = to_utf8(irr_work.data_agri.get("ben_father") or "NA")
...
def add_section_g(doc, plan, mws):
    ...
    for record in livelihood_records:
        ...
        if (
            ...
            row_cells[2].text = to_utf8(format_text(demands_promoting_livestock) or "NA")
            row_cells[3].text = to_utf8(record.beneficiary_settlement or "NA")
            row_cells[4].text = to_utf8(
                record.data_livelihood.get("beneficiary_name")
                or livestock_group.get("ben_livestock")
                or "NA"
            )
            row_cells[5].text = to_utf8(livestock_group.get("gender_livestock") or "NA")
            row_cells[6].text = to_utf8(livestock_group.get("ben_father_livestock") or "NA")
            row_cells[7].text = (
        ...
        if (
            ...
            row_cells[1].text = to_utf8(fisheries_group.get("demand_type_fisheries") or "NA")
            ...
            row_cells[2].text = to_utf8(format_text(demands_promoting_fisheries) or "NA")
            row_cells[3].text = to_utf8(record.beneficiary_settlement or "NA")
            row_cells[4].text = to_utf8(
                record.data_livelihood.get("beneficiary_name")
            ...
            row_cells[5].text = to_utf8(fisheries_group.get("gender_fisheries") or "NA")
            row_cells[6].text = to_utf8(fisheries_group.get("ben_father_fisheries") or "NA")
            row_cells[7].text = (
    ...
    for record in livelihood_records:
        ...
        if (
            ...
            row_cells[1].text = to_utf8(plantation_group.get("demand_type_plantations") or "NA")
        ...
        if (
            ...
            row_cells[6].text = to_utf8(kg_type)
            kg_area = (
