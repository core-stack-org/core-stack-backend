...
def proximity_status(proximity_gpkg: Path, config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    village_table = tables.get("village_shapes") or tables.get("village_points", "village_shapes")
    with sqlite3.connect(proximity_gpkg) as con:
        village_count = table_count(con, village_table) or 0
        ...
        status.update(
            {
                "village_layer": village_table,
                "village_shapes": village_count,
                "l3_rows": l3_count,
