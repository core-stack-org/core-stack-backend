...
# Resource Mapping
ODK_URL_settlement = ODK_BASE_URL + ODK_PROJECT_ID + "/forms/Add_Settlements_form%20_V1.0.1.svc/Submissions"
...
ODK_URL_livelihood = ODK_BASE_URL + ODK_PROJECT_ID + "/forms/NRM%20Livelihood%20Form.svc/Submissions"
ODK_URL_crop = ODK_BASE_URL + ODK_PROJECT_ID + "/forms/crop_form_V1.0.0.svc/Submissions"

# Maintenance forms
ODK_URL_WATERBODY_MAINTENANCE = ODK_BASE_URL + ODK_PROJECT_ID + "/forms/Propose_Maintenance_on_Existing_Water_Recharge_Structures_V1.1.1.svc/Submissions"
